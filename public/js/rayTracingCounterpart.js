...
(function () {
    ...
    // Center Y is at 0 to align with grid center.
    const spherePos = new BABYLON.Vector3(0, 0, -11);
    ...
    BABYLON.SceneLoader.ImportMeshAsync("", "models/", "camera.glb", scene).then((result) => {
        ...
        cameraModel.rotate(BABYLON.Axis.Y, Math.PI, BABYLON.Space.LOCAL);
        cameraModel.rotate(BABYLON.Axis.X, -Math.PI / 12, BABYLON.Space.LOCAL);
    });
